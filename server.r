...
shinyServer(function(input, output) {
  ...
  #authentication step
   consumer_key <-  "3AVDBz8wZPXYLWWIDC9Z7Q4J0"
  consumer_secret <- "Gf40WJYugPDZyKSXDBolG1DHuk1beLrgomDct31FPRiEl5hFf8"
  access_token <- "907474987505745921-cF9XT2XgXfZ2jDeugChWJDny3mk4OkH"
  access_secret <- "lQc6KeQPyBjwarRGpdmoUPaOB6XrHARsw06TdUNu5EF2d"
   ...
   TweetFrame<-function(twtList)
  {
	...
	pos.words = scan('/media/zack/E854-741F/twitter/practice/positive-words.txt', what='character', comment.char=';')
	neg.words = scan('/media/zack/E854-741F/twitter/practice/negative-words.txt', what='character', comment.char=';')
